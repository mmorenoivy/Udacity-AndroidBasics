...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //Parse the JSON using the following json link
            ...
            for(int i=0; i<earthquakeArray.length();i++)
            {
                ...
                double parseMagnitude = Double.parseDouble(magnitude);
                ...
                Earthquake earthquake = new Earthquake(parseMagnitude, location, time, url);
